...
namespace mz.platform {
	using System;
	abstract public class MzPlatConnectionOperationResult<T> {
		public enum Id {
			disconnected,
			failure,
			reply
		...
		public class Disconnected: MzPlatConnectionOperationResult<T> {
		...
		public class Failure: MzPlatConnectionOperationResult<T> {
		...
		public abstract partial class Reply: MzPlatConnectionOperationResult<T> {
			public new enum Id {
				positive,
				negative,
				unknown
			...
			public readonly RtPdu<T> pdu;
			public class Positive: Reply {
				public Positive(RtPdu<T> pdu): base(pdu, Id.positive) {
				}
				public override void Match(IMatch handler) {
			...
			public class Negative: Reply {
				public Negative(RtPdu<T> pdu): base(pdu, Id.negative) {
				}
				public override void Match(IMatch handler) {
			...
			public class Unknown: Reply {
				public Unknown(RtPdu<T> pdu): base(pdu, Id.unknown) {
				}
				public override void Match(IMatch handler) {
			...
			protected Reply(RtPdu<T> pdu, Id id): base(MzPlatConnectionOperationResult<T>.Id.reply) {
				this.pdu = pdu;
			}
			...
			public override void Match(MzPlatConnectionOperationResult<T>.IMatch handler) {
				handler.OnReply(this);
			}
			public override TMatch Match<TMatch>(MzPlatConnectionOperationResult<T>.IMatch<TMatch> handler) {
		...
		protected MzPlatConnectionOperationResult(Id id) {
		}
		public abstract void Match(IMatch handler);
		public abstract TMatch Match<TMatch>(IMatch<TMatch> handler);
