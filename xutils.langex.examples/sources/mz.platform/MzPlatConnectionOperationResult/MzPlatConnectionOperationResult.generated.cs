...
namespace mz.platform {
	using System;
	abstract public class MzPlatConnectionOperationResult {
		public enum Id {
			disconnected,
			failure,
			reply
		...
		public class Disconnected: MzPlatConnectionOperationResult {
		...
		public class Failure: MzPlatConnectionOperationResult {
		...
		public abstract partial class Reply: MzPlatConnectionOperationResult {
			public new enum Id {
				positive,
				negative,
				unknown
			...
			public class Unknown: Reply {
				public Unknown(RtPdu pdu): base(pdu, Id.unknown) {
				}
				public override void Match(IMatch handler) {
			...
			protected Reply(RtPdu pdu, Id id): base(MzPlatConnectionOperationResult.Id.reply) {
				this.pdu = pdu;
			}
			...
			public override void Match(MzPlatConnectionOperationResult.IMatch handler) {
				handler.OnReply(this);
			}
			public override TMatch Match<TMatch>(MzPlatConnectionOperationResult.IMatch<TMatch> handler) {
